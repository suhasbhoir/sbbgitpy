...
def backup(devices):
    ...
    shorun = connections.send_command("sho run")
    route = connections.send_command("sho ip route")
    rmap = connections.send_command("show route-map")
    siporto = connections.send_command("show ip protocols")
